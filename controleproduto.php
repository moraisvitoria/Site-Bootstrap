...
include_once 'conexao.php';
    ...
    if (!empty($dadoscad['btncad'])) {
        ...
        if(!$vazio) {
          ...
          $salvar->bindParam(':idcategoria', $dadoscad, PDO::PARAM_INT);
          $salvar->execute(); 
        ...
        if (!empty($dadoscad['btneditar'])) {
            ...
            $sql ="UPDATE aluno 
                   set nome=:nome,sexo=:sexo,datanascimento=:datanascimento,telefone=:telefone,cpf=:cpf,
                       rg=:rg,cep=:cep,numerocasa=:numerocasa,complemento=:complemento,foto=:foto,email=:email 
