...
1) Pesquisas todas as colunas com todos os registros.
select * from aluno;
2) Pesquisar nome e telefone de todos os alunos.
select nome,telefone from aluno;
3) Pesquisar nome e telefone que moram em apartamentos.

select nome,telefone from aluno
where
complemento like '%ap%';
4) Pesquisar nome e preço de todos os produtos em estoque.(soma dos valores).
	30 unidades.
...
select sum(valor*quantidade) as 'total de estoque' from produto;

/*Nomeando pesquisas/colunas */

select sum(valor*quatidade) as 'total de estoque' from produto;
...
dataaula >= '2022-12-6'
dataaula <= '2022-12-10';and

select * from aula whrere
dataaula between '2022-12-06' and '2022-12-10' ;
8) Pesquisar as  informações de aulas executadas nos dias
06/12/2022 e 10/12/2022.
select * from aula where
dataaula in ('2022-12-06' ,'2022-12-10');

9) Pesquisar o nome, telefone, e cpf de todas as alunas que o nome comece com letra M.
